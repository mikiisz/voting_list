...
##### Analiza wykresu
Powyższy wykres przedstawia wykresy pudełkowe dla zawodów, których kandydaci uzyskali w sumie największą liczbę głosów (te zawody są posortowane względem tej sumy). Jak widać, liczba głosów oddanych na Panią Beatę Szydło z pewnością wystarczyła, aby ten zawód znajdował się na 1. miejscu (pomimo małego poparcia dla pozostałych kandydatów tego zawodu, o czym świadczy mały rozstęp międzykwartylowy ulokowany bardzo nisko). Jednak w przypadku kolejnych zawodów przewagę w tym zestawieniu daje duża liczba kandydatów, którzy uzbierali odstającą liczbę głosów od pozostałej reszty kandydatów tego samego zawodu. Natomiast w przypadku zawodu historyka, posła do Parlamentu Europejskiego, polityka oraz filologa angielskiego, prawie wszyscy kandydaci tych zawodów osiągneli podobne poparcie w obrębie swojego zawodu, o czym świadczy brak wartości odstających. Ponadto, dla zawodów związanych z polityką oraz dodatkowo zawodem lekarza, większość kandydatów cieszyła się wysokim poparciem. Świadczy o tym wysoka wartość mediany dla tych zawodów oraz wysoko usytuowany kwartyl dolny. W zestawieniu znalazły się również takie zawody, dla których rozstęp miedzykwartylowy określony jest bardzo nisko, np. zawód pedagoga, przedsiębiorcy albo rolnika. Większość kandydatów tych zawodów miała znikome poparcie, być może byli mało znani. Dla zawodu pracownika humanitarnego oraz lekarza - specjalisty pediatrii mamy jedynie jednego reprezentanta ma dany zawód - jest to przedstawione na wykresie za pomocą "kreski" z odpowiednio przedstawionego wykresu pudełkowego. Pomimo tego, liczba głosów oddanych na tych kandydatów pozwoliła na znalezienie się ich zawodów w zestawieniu.
